...
Since Version 8.2.0, the loki helm chart offers a new configuration syntax. The new syntax is more consistent and easier to use. The old syntax is still supported, but it is recommended to switch to the new syntax.
